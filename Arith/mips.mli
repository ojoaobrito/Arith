...
val add : register -> register -> int -> text
val addr : register -> register -> register -> text
val sub : register -> register -> int -> text
val subr : register -> register -> register -> text
val mult : register -> register -> text
...
(** carregar o octeto para o endere̤o dado sem extenṣo de sinal (valor
    entre 0 e 255) *)
val lw : register -> register -> text
val lvw : register -> register -> text
...
(** escrever os 8 bits menor signific̢ncia do registo dado pelo endere̤o
    dado *)
val sw : register -> register -> text
val svw : register -> register -> text
